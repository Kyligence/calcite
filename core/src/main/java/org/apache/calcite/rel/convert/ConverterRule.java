...
public abstract class ConverterRule
  ...
  protected <R extends RelNode> ConverterRule(Class<R> clazz,
      io.kyligence.kap.guava20.shaded.common.base.Predicate<? super R> predicate,
  ...
  @Deprecated // to be removed before 2.0
  protected <R extends RelNode> ConverterRule(Class<R> clazz,
      io.kyligence.kap.guava20.shaded.common.base.Predicate<? super R> predicate, RelTrait in,
