...
public enum Hook {
  ...
  public <T, R> Closeable addThread(
      final io.kyligence.kap.guava20.shaded.common.base.Function<T, R> handler) {
  ...
  public static <V> io.kyligence.kap.guava20.shaded.common.base.Function<Holder<V>, Void>
      property(final V v) {
    return holder -> {
      holder.set(v);
      return null;
