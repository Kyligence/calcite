...
public class RexUtil {
  ...
  @Deprecated // to be removed before 2.0
  public static io.kyligence.kap.guava20.shaded.common.base.Function<RexNode, RexNode> notFn(
  ...
  public static class SubQueryFinder extends RexVisitorImpl<Void> {
    ...
    @SuppressWarnings("Guava")
    @Deprecated // to be removed before 2.0
    public static final io.kyligence.kap.guava20.shaded.common.base.Predicate<Join> JOIN_PREDICATE =
        SubQueryFinder::containsSubQuery;
