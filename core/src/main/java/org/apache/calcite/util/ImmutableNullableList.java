 ...
 * {@link io.kyligence.kap.guava20.shaded.common.collect.ImmutableList}.</p>
 *
...
public class ImmutableNullableList<E> extends AbstractList<E> {
   ...
   *
   * <p>Behavior as
   * {@link io.kyligence.kap.guava20.shaded.common.collect.ImmutableList#copyOf(java.util.Collection)}
   ...
   *
   * <p>Behavior as
   * {@link io.kyligence.kap.guava20.shaded.common.collect.ImmutableList#copyOf(Iterable)}
   ...
   *
   * <p>Behavior as
   * {@link io.kyligence.kap.guava20.shaded.common.collect.ImmutableList#copyOf(Object[])}
   * except that this list allows nulls.</p>
   */
