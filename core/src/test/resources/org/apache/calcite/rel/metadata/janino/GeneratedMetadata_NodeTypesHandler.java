...
public final class GeneratedMetadata_NodeTypesHandler
  ...
  public io.kyligence.kap.guava20.shaded.common.collect.Multimap getNodeTypes(
    ...
    if (v != null) {
      ...
      return (io.kyligence.kap.guava20.shaded.common.collect.Multimap) v;
    }
    mq.map.put(r, key,org.apache.calcite.rel.metadata.NullSentinel.ACTIVE);
    try {
      final io.kyligence.kap.guava20.shaded.common.collect.Multimap x = getNodeTypes_(r, mq);
  ...
  private io.kyligence.kap.guava20.shaded.common.collect.Multimap getNodeTypes_(
      org.apache.calcite.rel.RelNode r,
      org.apache.calcite.rel.metadata.RelMetadataQuery mq) {
